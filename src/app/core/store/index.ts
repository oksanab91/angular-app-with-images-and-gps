...
import { flightsSelect$, citiesSelect, iataSelect, showSelect$, showSelect, showJobsSelect$, remotejobsSelect$, greenhouseJobsSelect$, jobsMessageSelect } from './widget.store';
...
export const stores = [
    ...
    dynamicsChartSelect$, dynamicsChartFilledSelect$, showJobsSelect$, remotejobsSelect$, 
    greenhouseJobsSelect$, jobsMessageSelect
];
